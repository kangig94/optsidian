...
export const EXTENDED_COMMANDS = ["search", "similarity", "index", "config", "grep", "frontmatter", "edit", "apply_patch", "write", "copy", "mkdir", "open-gui", "update", "plugin:install"] as const;
