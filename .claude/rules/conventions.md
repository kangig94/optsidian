...
**Naming**: kebab-case for CLI command names and source file names (`apply-patch.ts`, `write-file.ts`); camelCase for TypeScript identifiers; SCREAMING_SNAKE_CASE for module-level constants (`INDEX_BUILD_VERSION`, `EXTENDED_COMMANDS`).
