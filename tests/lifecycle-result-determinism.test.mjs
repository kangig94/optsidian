...
import { DaemonSearchStoreService, rankingTuningHash } from '../src/daemon/search-store/service.ts';
...
test('AC11 ranking tuning changes query identity only, never lexical or retrieval identity', () => {
  ...
  assert.equal(
    settingsIdentity.rankingTuningHash,
    rankingTuningHash({
      rrfK: 40,
  ...
  assert.equal(
    overrideIdentity.rankingTuningHash,
    rankingTuningHash({
      rrfK: 11,
