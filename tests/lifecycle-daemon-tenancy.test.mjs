...
import { VaultPublisher, editionCoverageFromCorpus } from '../src/daemon/search-store/publisher.ts';
...
test('AC7 partial-bind is unrepresentable under a single tenancy socket record', () => {
  ...
  assert.deepEqual(
    ...
    ['binaryVersion', 'epoch', 'incarnationId', 'pid', 'slot', 'socketPath', 'startedAt'].sort(),
  );
