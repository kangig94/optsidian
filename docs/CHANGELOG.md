...
- Improve ranking by keeping weak ngram-only metadata coverage in the base bucket, ignoring weak English function words for metadata coverage, and using a gated body evidence signal for long Latin queries, raising KLUE100 to 100/100, English100 to 92/100, and Mixed200 to 192/200.
