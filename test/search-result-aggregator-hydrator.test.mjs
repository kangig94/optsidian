...
test("ResultAggregator and ResultHydrator are byte-identical across shuffled shard completion", () => {
  const finalists = {
    a: finalist({ id: "candidate-a", documentId: "doc-a", pathName: "a.md", title: "Alpha", segmentId: "segment-1", partitionId: 1, localDocId: 1, score: 3, baseRank: 3 }),
    b: finalist({ id: "candidate-b", documentId: "doc-b", pathName: "b.md", title: "Bravo", segmentId: "segment-2", partitionId: 2, localDocId: 1, score: 11, baseRank: 1 }),
    c: finalist({ id: "candidate-c", documentId: "doc-c", pathName: "c.md", title: "Charlie", segmentId: "segment-3", partitionId: 3, localDocId: 1, score: 7, baseRank: 2 }),
    d: finalist({ id: "candidate-d", documentId: "doc-d", pathName: "d.md", title: "Delta", segmentId: "segment-4", partitionId: 4, localDocId: 1, score: 7, baseRank: 4 })
  };
  const documents = [
  ...
  for (const order of permutations) {
    ...
    assert.deepEqual(aggregation.finalists.map((entry) => entry.candidate.candidateId), [
      "candidate-b",
      "candidate-c",
      "candidate-d",
      "candidate-a"
...
test("AC4 split keeps aggregation separate and delegates finalist ordering to shared helpers", () => {
  ...
  assert.doesNotMatch(aggregatorSource, /documentsFromHandle|snippetsForDocument|matchDebug|explainTrace|SearchMatch|ResultHydrator/);
